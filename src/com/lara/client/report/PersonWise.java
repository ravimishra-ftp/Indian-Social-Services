...
public class PersonWise extends Action {
	String sqlQry="";
	public String process(HttpServletRequest request, Bean bean)
	{
		...
		String firstName = serviceBean.getServiceName();
		Statement stmt = null;
		ResultSet rs = null;
		...
		try 		
		{
			...
			sqlQry =  "Select distinct PanchayatName, VillageName,to_char(PersonMaster.datetime,'dd/MM/yyyy')dt,firstName,LastName,Gender,Age," +
					...
					"PersonChild.ServiceId = PersonChild.ServiceId where FirstName like '%" + firstName + "%'";
			...
			ArrayList person = new ArrayList();
				...
				request.setAttribute("path", "Report/personWise.jsp");
