...
<script type="text/javascript">
	...
	var serviceName = myForm.serviceName;
	if (serviceName.value==null || serviceName.value=="0")
	{
...
<body>
	<form action="../serviceWiseReport.do" accept-charset="utf-8">
	<%
		...
		HashMap map = null;
			...
			try
			{
				...
				stmt = con.createStatement();
				 ...
				 sql = "select ServiceId, ServiceName from SOCIALSERVICE";  
	...
	%>
		<table width="100%" align="center">
			...
			<tr>
				...
				<td>
					<select name="serviceName" style="width: 145px">
				...
				<td class="form_settings" colspan="3" align="right">
						<input class="submit" type="submit" value="Search" onclick="return validate()"/>
					</td>
			</tr>			
		</table>
		</td>
